...
class ListParticularPostComponent extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        return (
            <div>
                <h2 className="text-center">Publication de niveau Particuliers</h2>
                <div className="row" >
...
export default ListParticularPostComponent